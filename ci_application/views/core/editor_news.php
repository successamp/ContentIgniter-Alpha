...
?>    <div class="ci_col-5of6">
        <div class=" admin_box">
        <h1 class="admin_box_title">Add / Update / Edit News</h1>
             <p>New News Item: <a href="/editor/news_add/"><img src="/static/img/icons/Add.png" height="36" width="36" alt="Create A News Post" style="vertical-align: middle;"/></a></p>
<?php
...
?>
                    <tr class="subdom sub<?=$item['subdomain'].$active_class;?>">
                          <td><a href="/editor/news_edit/<?=$item['id'];?>/" class="ci_admin_content_box"><img src="/static/img/icons/Modify.png" height="24" width="24" alt="Content"/></a></td>
                          <td><?=$subdomain;?></td>
                          <td><?=$active;?></td>
                          <td><a target="_blank" href="/news/<?=$url;?>/">/news/<?=$url;?>/</a></td>
                          <td><?=$item['title'];?></td>
                          <td class="end"><em><?=$item['description'];?></em></td>
                          <td><a href="/editor/news_delete/<?=$item['id'];?>/" class="ci_admin_delete"><img src="/static/img/icons/Delete.png" height="24" width="24" alt="Delete This News Item" title="delete /news/<?=$url;?>/"/></a></td>
                    </tr>
<?php
}
?>
