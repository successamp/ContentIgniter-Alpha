...
<div id="Content" class="ci_col-1of1 clearfix ci_bottom">
    <div class="ui-widget ui-widget-content ui-corner-all clearfix">
        <h1 class="ui-widget-header ci-admin-header" id="PageTitle">Upload Custom Image
            <small>
                <button href="/editor/home/">Return To Editor Home</button>
            </small>
        </h1>
...
<?php
        ...
        if(!empty($success)){
            echo '<div class="msg success">Successfully uploaded "'.$success.'"</div>';
        }
?>
        <?php
        echo $page_content;
