...
<div class="ci_col-5of6">
    <div class=" admin_box">
        ...
        <p>New Page: <a href="/admin/pages_add_page/"><img src="/static/img/icons/Add.png" height="48" width="48"
                                                           alt="Create A New Page"/></a></p>
        ...
        <table style="width:100%;" class="admin_table">
            ...
            foreach ($page_admin_data as $item) {
                ...
                <tr>
                    <td><?=$subdomain;?></td>
                    <td><a target="_blank"
                           href="/<?=$url;?><?=empty($url) ? '' : '/';?>">/<?=$url;?><?=empty($url) ? '' : '/';?></a>
                    </td>
                    <td><a href="/admin/pages_edit/<?=$item['id'];?>/" class="ci_admin_edit_box"><img
                            src="/static/img/icons/Info.png" height="24" width="24" alt="Page Info"/></a> <a
                            href="/admin/pages_content/<?=$item['id'];?>/" class="ci_admin_content_box"><img
                            src="/static/img/icons/Modify.png" height="24" width="24" alt="Content"/></a> <a
                            href="/admin/pages_delete/<?=$item['id'];?>/" class="ci_admin_delete"><img
