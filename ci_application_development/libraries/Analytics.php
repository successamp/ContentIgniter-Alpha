...
class Analytics
{
    ...
    function __construct()
    {
        ...
        if (empty($user_tracking)) {
            ...
            $cookie_data                      = json_decode($_COOKIE['CI_user_tracking']);
            $userdata                         = array();
            $userdata['user_tracking_refer']  = empty($cookie_data->refer) ? $_SERVER['HTTP_REFERER'] : $cookie_data->refer;
            $userdata['user_tracking_entry']  = empty($cookie_data->entry) ? $_SERVER['REQUEST_URI'] : $cookie_data->entry;
            $userdata['user_tracking_domain'] = empty($cookie_data->domain) ? $_SERVER['SERVER_NAME'] : $cookie_data->domain;
